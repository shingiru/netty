...
public class LocalChannel extends AbstractChannel {
    ...
    protected void doRegister() throws Exception {
        // Check if peer is not null and parent is not null as this means it was a LocalChannel created by a
        // LocalServerChannel. This is needed as a peer may not be null also if a LocalChannel was connected before and
